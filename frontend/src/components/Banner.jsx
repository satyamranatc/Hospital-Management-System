...
const Banner = () => {
    ...
    return (
        <div className='flex bg-primary px-4 sm:px-[10%] md:px-14 lg:px-12 my-20'>
            {/* Left Side */}
            ...
            <div className='hidden md:block md:w-1/2 lg:w-[370px] relative'>
                <div className='w-full absolute bottom-0 right-0 max-w-md h-full flex items-end justify-center'>
